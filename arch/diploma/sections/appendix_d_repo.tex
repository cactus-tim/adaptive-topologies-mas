...
состояния.\quad
\textbf{\code{atm.human}} --- слой человека в контуре управления
(от англ. Human-in-the-Loop, HITL) --- протокол
\code{HumanGateway}, реализации шлюзов, маршрутизатор ролей,
политика тайм-аутов.\quad
...
\textbf{\code{conf/tasks/}} --- загрузчики корпусов
и стратифицированные выборки.\quad
